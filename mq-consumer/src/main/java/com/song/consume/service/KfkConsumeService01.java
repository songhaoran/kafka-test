...
@Component
@Slf4j
public class KfkConsumeService01 {

    @KafkaListener(topics = {"song_test_2"}, groupId = "local_consumer_2", containerFactory = "kafkaListenerContainerFactory")
    public void listenSongTest(ConsumerRecord<Object, Object> data, Acknowledgment ack) {
        log.info("topic->{},data->{}", "song_test_2", JSON.toJSONString(data));
